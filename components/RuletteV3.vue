...
const spinWheel = () => {
  ...
  // Calculate the position for number 97
  // Find the index of number 97 in the numbers array
  const targetIndex = numbers.value.findIndex(num => num === '97');
  
  // Calculate the angle needed to land on 97
  ...
  // Calculate the final rotation to make it land on 97
